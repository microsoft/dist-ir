...
NumPyRegister = {
    ...
    ("MPIGather", (np.ndarray,) * 2): gather,
    ("MPIGather", (np.ndarray,) * 4): gather,
    ("MPIGather", (np.ndarray,) * 8): gather,
    ("MPIGather", (np.ndarray,) * 16): gather,
    ("MPIGather", (np.ndarray,) * 32): gather,
    ("MPIGather", (np.ndarray,) * 64): gather,
    ("MPIGather", (np.ndarray,) * 128): gather,
    ("MPIGather", (np.ndarray,) * 256): gather,
    ("MPIGather", (np.ndarray,) * 512): gather,
    ("MPIGather", (np.ndarray,) * 1024): gather,
    ("MPIGather", (np.ndarray,) * 2048): gather,
    ("MPIGather", (np.ndarray,) * 4096): gather,
    ("MPIGather", (np.ndarray,) * 8192): gather,
