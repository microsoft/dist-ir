...
OpRegister = {
    ...
    "Group": OpRegisterEntry(num_inputs=1, num_outputs=1),
    ...
    "LambOptimizer": OpRegisterEntry(num_inputs=1, num_outputs=1),
    ...
    "Sum": OpRegisterEntry(num_inputs=2, num_outputs=1),
    ...
    "ZeroGradient": OpRegisterEntry(num_inputs=1, num_outputs=1),
}
