...
OpRegister = {
    ...
    "MPIBroadcast_v2": OpRegisterEntry(num_inputs=1, num_outputs=1),
    "MPIGather_v2": OpRegisterEntry(num_inputs=1, num_outputs=1),
    "MPIReduce_v2": OpRegisterEntry(num_inputs=1, num_outputs=1),
    "MPIScatter_v2": OpRegisterEntry(num_inputs=1, num_outputs=1),
