...
def test_mnist():
    ...
    x = module.add_input_value("x", Tensor(Float(), (16, 4)), device=d0)
    z = module.add_input_value("z", Tensor(Float(), (16,)), device=d0)
    wA = module.add_input_value("wA", Tensor(Float(), (4, 4)), device=d0)
    wB = module.add_input_value("wB", Tensor(Float(), (4, 4)), device=d0)
